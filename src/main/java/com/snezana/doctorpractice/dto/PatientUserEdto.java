...
/**
 * PatientUserE DTO (Data Transfer Object) class format for editing personal and
 * user data for patient (with annotations used for field validation)
 */
public class PatientUserEdto {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PatientUserEdto other = (PatientUserEdto) obj;
		if (address == null) {
	...
	public String toString() {
		return "PatientUserEdto [id=" + id + ", username=" + username + ", email=" + email + ", address=" + address
				+ ", telephone=" + telephone + ", userStatus=" + userStatus + ", firstName=" + firstName + ", lastName="
				+ lastName + ", gender=" + gender + ", hsCode=" + hsCode + ", other=" + other + ", birthDate="
				+ birthDate + "]";
	}
