...
/**
 * DoctorUser DTO (Data Transfer Object) class format for adding new personal
...
public class DoctorUserDto {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DoctorUserDto other = (DoctorUserDto) obj;
		if (address == null) {
	...
	public String toString() {
		return "DoctorUserDto [id=" + id + ", username=" + username + ", password=" + password + ", confirmPassword="
