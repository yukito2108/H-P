...
/**
 * DoctorUserE DTO (Data Transfer Object) class format for editing personal
 * and user data for doctor (with annotations used for field validation)
 */
public class DoctorUserEdto {
	...
	@NotNull
	@Pattern(regexp = "\\p{L}{6}", message = "Qualifications must has 6 letters")
	private String qualifications;

	@NotNull
	@Pattern(regexp = "\\d{6}", message = "Licence Code must has 6 numbers")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DoctorUserEdto other = (DoctorUserEdto) obj;
		if (address == null) {
	...
	public String toString() {
		return "DoctorUserEDto [id=" + id + ", username=" + username + ", email=" + email + ", address=" + address
				+ ", telephone=" + telephone + ", userStatus=" + userStatus + ", firstName=" + firstName + ", lastName="
				+ lastName + ", gender=" + gender + ", qualifications=" + qualifications + ", licenceCode="
				+ licenceCode + ", other=" + other + ", birthDate=" + birthDate + "]";
	}
