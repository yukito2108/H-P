...
/**
 * Password validator class that enforces the rules used for validation during
...
public class PasswordConstraintValidator implements ConstraintValidator<ValidPassword, String> {
	...
	/**
	 * Method where validation rules for password creation are defined
	 */
	@Override
	public boolean isValid(final String password, final ConstraintValidatorContext context) {
		// @formatter:off
		final PasswordValidator validator = new PasswordValidator(Arrays.asList(new LengthRule(4, 30),
